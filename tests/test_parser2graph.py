...
def sample_pdb_file(tmpdir_factory):
    ...
    pdb_content = """
    # Sample PDB content
    ATOM      1  N   ASP A   1       3.373  -4.042   1.886  1.00 20.00           N  
...
def test_construct_torch_graph():
    ...
    sample_bonds = [
        {'atom1_coord': [3.373, -4.042, 1.886], 'atom2_coord': [4.658, -4.682, 1.669]},  # Bond 1
        {'atom1_coord': [4.658, -4.682, 1.669], 'atom2_coord': [5.671, -3.727, 2.302]},  # Bond 2
        {'atom1_coord': [5.671, -3.727, 2.302], 'atom2_coord': [5.285, -2.545, 2.254]},  # Bond 3
        {'atom1_coord': [4.658, -4.682, 1.669], 'atom2_coord': [4.476, -5.989, 0.862]},  # Bond 4
        {'atom1_coord': [4.476, -5.989, 0.862], 'atom2_coord': [5.654, -6.823, 1.350]},  # Bond 5
        {'atom1_coord': [5.654, -6.823, 1.350], 'atom2_coord': [6.593, -6.258, 2.003]},  # Bond 6
        {'atom1_coord': [5.654, -6.823, 1.350], 'atom2_coord': [5.682, -8.077, 1.067]},  # Bond 7
        {'atom1_coord': [6.882, -4.204, 2.815], 'atom2_coord': [7.996, -3.408, 3.383]},  # Bond 8
        {'atom1_coord': [7.996, -3.408, 3.383], 'atom2_coord': [7.674, -2.036, 3.945]},  # Bond 9
        {'atom1_coord': [7.674, -2.036, 3.945], 'atom2_coord': [6.568, -1.614, 4.302]},  # Bond 10
        {'atom1_coord': [7.996, -3.408, 3.383], 'atom2_coord': [9.194, -4.300, 3.746]},  # Bond 11
        {'atom1_coord': [9.194, -4.300, 3.746], 'atom2_coord': [10.350, -3.452, 4.256]},  # Bond 12
        {'atom1_coord': [9.194, -4.300, 3.746], 'atom2_coord': [9.591, -5.645, 3.142]}    # Bond 13
    ]

    # Call the function
    data = construct_torch_graph(sample_atoms, sample_bonds)
    # Perform assertions to verify the output
    assert data.x.shape[0] == len(sample_atoms)  # Check the number of nodes
    assert data.edge_index.shape[1] == len(sample_bonds)  # Check the number of edges
